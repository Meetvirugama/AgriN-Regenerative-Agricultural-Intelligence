    ...
    <div className="min-h-screen bg-[var(--bg-color)] flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-[var(--card-bg)] rounded-2xl shadow-xl border border-[var(--border-color)] overflow-hidden">
        ...
        <div className="bg-[var(--primary)] p-6 text-[var(--bg-color)] text-center">
          ...
          <p className="text-sm opacity-90">Let's set up your first field profile.</p>
        </div>

        {/* Form Body */}
        <div className="p-6">
          <div className="flex items-center gap-2 mb-8">
            <div className={`h-2 flex-1 rounded-full ${step >= 1 ? 'bg-[var(--primary)]' : 'bg-[var(--border-color)]'}`} />
            <div className={`h-2 flex-1 rounded-full ${step >= 2 ? 'bg-[var(--primary)]' : 'bg-[var(--border-color)]'}`} />
          </div>
          ...
          {step === 1 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">Field Name</label>
                  <input
                    type="text"
                    value={fieldName}
          ...
          {step === 2 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">Primary Crop</label>
                  <select
                    value={cropType}
