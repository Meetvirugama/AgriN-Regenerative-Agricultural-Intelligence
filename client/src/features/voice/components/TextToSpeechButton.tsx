...
export const TextToSpeechButton: React.FC<TextToSpeechButtonProps> = ({ textToRead, className = '' }) => {
  ...
  const handlePlay = async (e: React.MouseEvent) => {
    ...
    const audioDataUrl = await voiceApi.tts(textToRead, localStorage.getItem('agri_lang') || 'en-US');
