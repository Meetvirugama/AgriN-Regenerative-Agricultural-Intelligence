...
export function WeatherAlertBanner({ flags }: WeatherAlertBannerProps) {
  ...
  activeFlags.sort((a, b) => severityScore[b.severity] - severityScore[a.severity]);
  ...
  const getAlertContent = (flag: WeatherEventFlag) => {
    let icon, title;
  ...
  return (
    <div className={`${content.color} border-2 ${content.borderColor} ${content.textColor} p-4 rounded-xl shadow-md mb-6 animate-fade-in`}>
