...
import { Sprout, Phone, ArrowRight, RotateCcw, CheckCircle, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      ...
      <div className="flex items-center gap-3 mb-12">
        ...
        <span className="text-2xl font-black tracking-tight text-text">AgriMesh</span>
      </div>
      ...
      <div className="w-full max-w-sm">
        ...
        {step === 'phone' && (
          <div className="animate-fade-in-up">
            ...
            <p className="text-text-muted mb-8">Enter your phone number to continue.</p>
            <form onSubmit={handlePhoneSubmit} className="flex flex-col gap-4">
              ...
              {error && (
                <p className="text-sm text-danger font-medium animate-fade-in-up">{error}</p>
              )}
        ...
        {step === 'otp' && (
          <div className="animate-fade-in-up">
            ...
            <h1 className="text-3xl font-black text-text mb-2">Enter your code</h1>
            <p className="text-text-muted mb-8">
              We sent a 6-digit code to <strong className="text-text">{phone}</strong>
            </p>
            ...
            {error && (
              <p className="text-sm text-danger font-medium mb-4 animate-fade-in-up">{error}</p>
            )}
        ...
        {step === 'success' && (
          <div className="flex flex-col items-center gap-4 animate-fade-in-up">
            ...
            <p className="text-text-muted text-center">Taking you to your field dashboard…</p>
          </div>
        )}
      </div>
    </div>
