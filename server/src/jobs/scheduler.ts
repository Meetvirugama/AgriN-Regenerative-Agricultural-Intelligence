...
import { runDailyWeatherIngestion } from './ingestWeather';
import { runNightlyStageRecompute } from './recomputeStages';
...
export function startScheduler(): void {
  ...
  console.log('[Scheduler] Registered 2 jobs: weather (hourly), stage-recompute (01:00 UTC daily)');
}
